...
TAMANIO_MUESTRA  = 1592             # normas para completar el lote de 2500 (2500 - 908)
...
def cargar_normas_desde_bd() -> pd.DataFrame:
    ...
    return pd.read_sql("""
        ...
        WHERE resumen IS NOT NULL
          ...
          AND (es_muestra_entrenamiento IS NULL OR es_muestra_entrenamiento = 0)
    """, engine)
...
if MODO == "muestra_piloto":
    ...
    piloto = piloto[[
        ...
        "tema", "titulo", "resumen", "tu_etiqueta", "etiqueta_director"
    ]]
...
# ============================================================
    log.info(f"Generando muestra estratificada complementaria de {TAMANIO_MUESTRA} normas...")

    df_total = cargar_normas_desde_bd()
    log.info(f"Normas limpias disponibles en BD: {len(df_total)}")
    ...
    muestra = muestra[[
        "id", "tipo_normativa", "numero_norma", "ano_sancion",
        "tema", "titulo", "resumen", "politica_energetica", "notas"
    ]]
